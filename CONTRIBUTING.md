...
# Contribute to Ory codex-plugins<!-- omit in toc -->
...
_Please note_: We take Ory codex-plugins's security and our users' trust very
seriously. If you believe you have found a security issue in Ory codex-plugins,
...
[Ory codex-plugins Discussions](https://github.com/orgs/ory/discussions) or the
[Ory Chat](https://www.ory.com/chat).

## FAQ

- I am new to the community. Where can I find the
  [Ory Community Code of Conduct?](https://github.com/ory/codex-plugins/blob/master/CODE_OF_CONDUCT.md)

- I have a question. Where can I get
  [answers to questions regarding Ory codex-plugins?](#communication)
...
- I want to talk to other Ory codex-plugins users.
  [How can I become a part of the community?](#communication)

- I would like to know what I am agreeing to when I contribute to Ory
  codex-plugins.
  Does Ory have
  [a Contributors License Agreement?](https://cla-assistant.io/ory/codex-plugins)

- I would like updates about new versions of Ory codex-plugins.
  [How are new releases announced?](https://www.ory.com/l/sign-up-newsletter)

## How can I contribute?

The single most useful thing you can do is to
[open a well-written issue or discussion](https://github.com/ory/codex-plugins/issues):
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory codex-plugins.
...
- **Help with open issues.** We have a lot of open issues for Ory codex-plugins and
...
Check out [Ory codex-plugins Discussions](https://github.com/orgs/ory/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory codex-plugins,
...
1. Add a descriptive prefix to commits. This ensures a uniform commit history
   ...
   [Conventional Commits configuration](https://github.com/ory/codex-plugins/blob/master/.github/workflows/conventional_commits.yml)
...
[Contributor License Agreement](https://cla-assistant.io/ory/codex-plugins).
...
maintain the quality and reliability of Ory codex-plugins, please follow these
guidelines:
...
git clone git@github.com:ory/codex-plugins.git
